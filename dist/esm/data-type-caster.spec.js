...
describe('DataTypeCaster', function () {
    ...
    describe('cast', function () {
        ...
        describe('to array', function () {
            ...
            describe('array value', function () {
                ...
                it('throws TypeCastError on items casting fail', function () {
                    const s = new DataTypeCaster();
                    const throwable = () => s.cast([10, '20', 'lorem'], {
                        type: DataType.ARRAY,
                        items: { type: DataType.NUMBER },
                    });
                    expect(throwable).to.throw(TypeCastError);
        ...
        describe('noTypeCastError', function () {
            it('skips casting when target type is Any', function () {
                const s = new DataTypeCaster();
                const res = s.cast('value', { type: DataType.ANY }, { noTypeCastError: true });
                expect(res).to.be.eq('value');
            });
            describe('to string', function () {
                it('skips casting for null', function () {
                    const s = new DataTypeCaster();
                    const res = s.cast(null, { type: DataType.STRING }, { noTypeCastError: true });
                    expect(res).to.be.null;
                });
                it('skips casting for undefined', function () {
                    const s = new DataTypeCaster();
                    const res = s.cast(undefined, { type: DataType.STRING }, { noTypeCastError: true });
                    expect(res).to.be.undefined;
                });
                it('skips casting for string', function () {
                    const s = new DataTypeCaster();
                    const res = s.cast('value', { type: DataType.STRING }, { noTypeCastError: true });
                    expect(res).to.be.eq('value');
                });
                it('casts number to string', function () {
                    const s = new DataTypeCaster();
                    const res = s.cast(10, { type: DataType.STRING }, { noTypeCastError: true });
                    expect(res).to.be.eq('10');
                });
                it('skips casting for boolean', function () {
                    const s = new DataTypeCaster();
                    const res = s.cast(true, { type: DataType.STRING }, { noTypeCastError: true });
                    expect(res).to.be.eq(true);
                });
                it('skips casting for array', function () {
                    const s = new DataTypeCaster();
                    const res = s.cast([1, 2, 3], { type: DataType.STRING }, { noTypeCastError: true });
                    expect(res).to.be.eql([1, 2, 3]);
                });
                it('skips casting for object', function () {
                    const s = new DataTypeCaster();
                    const res = s.cast({ foo: 'bar' }, { type: DataType.STRING }, { noTypeCastError: true });
                    expect(res).to.be.eql({ foo: 'bar' });
                });
            });
            describe('to array', function () {
                it('skips casting for null', function () {
                    const s = new DataTypeCaster();
                    const res = s.cast(null, { type: DataType.ARRAY }, { noTypeCastError: true });
                    expect(res).to.be.null;
                });
                it('skips casting for undefined', function () {
                    const s = new DataTypeCaster();
                    const res = s.cast(undefined, { type: DataType.ARRAY }, { noTypeCastError: true });
                    expect(res).to.be.undefined;
                });
                describe('string value', function () {
                    it('skips casting for non-JSON string', function () {
                        const s = new DataTypeCaster();
                        const res = s.cast('value', { type: DataType.ARRAY }, { noTypeCastError: true });
                        expect(res).to.be.eq('value');
                    });
                    it('casts JSON array to array', function () {
                        const s = new DataTypeCaster();
                        const res = s.cast('[1, 2, 3]', { type: DataType.ARRAY }, { noTypeCastError: true });
                        expect(res).to.be.eql([1, 2, 3]);
                    });
                    it('skips casting for JSON object', function () {
                        const s = new DataTypeCaster();
                        const res = s.cast('{"foo": "bar"}', { type: DataType.ARRAY }, { noTypeCastError: true });
                        expect(res).to.be.eql('{"foo": "bar"}');
                    });
                });
                it('skips casting for number', function () {
                    const s = new DataTypeCaster();
                    const res = s.cast(10, { type: DataType.ARRAY }, { noTypeCastError: true });
                    expect(res).to.be.eq(10);
                });
                it('skips casting for boolean', function () {
                    const s = new DataTypeCaster();
                    const res = s.cast(true, { type: DataType.ARRAY }, { noTypeCastError: true });
                    expect(res).to.be.eq(true);
                });
                describe('array value', function () {
                    it('skips casting if no items schema specified', function () {
            ...
            describe('to object', function () {
                it('skips casting for null', function () {
                    const s = new DataTypeCaster();
                    const res = s.cast(null, { type: DataType.OBJECT }, { noTypeCastError: true });
                    expect(res).to.be.null;
                });
                it('skips casting for undefined', function () {
                    const s = new DataTypeCaster();
                    const res = s.cast(undefined, { type: DataType.OBJECT }, { noTypeCastError: true });
                    expect(res).to.be.undefined;
                });
                describe('string value', function () {
                    it('skips casting for non-JSON string', function () {
                        const s = new DataTypeCaster();
                        const res = s.cast('value', { type: DataType.OBJECT }, { noTypeCastError: true });
                        expect(res).to.be.eq('value');
                    });
                    it('skips casting for JSON array', function () {
                        const s = new DataTypeCaster();
                        const res = s.cast('[1, 2, 3]', { type: DataType.OBJECT }, { noTypeCastError: true });
                        expect(res).to.be.eql('[1, 2, 3]');
                    });
                    it('casts JSON object to object', function () {
                        const s = new DataTypeCaster();
                        const res = s.cast('{"foo": "bar"}', { type: DataType.OBJECT }, { noTypeCastError: true });
                        expect(res).to.be.eql({ foo: 'bar' });
                    });
                });
                it('skips casting for number', function () {
                    const s = new DataTypeCaster();
                    const res = s.cast(10, { type: DataType.OBJECT }, { noTypeCastError: true });
                    expect(res).to.be.eq(10);
                });
                it('skips casting for boolean', function () {
                    const s = new DataTypeCaster();
                    const res = s.cast(true, { type: DataType.OBJECT }, { noTypeCastError: true });
                    expect(res).to.be.eq(true);
                });
                it('skips casting for array', function () {
                    const s = new DataTypeCaster();
