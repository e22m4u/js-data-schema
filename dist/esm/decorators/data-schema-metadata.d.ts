 ...
 */
export type DataSchemaMetadataItems = DataSchemaMetadata | DataSchemaClassFactory;
/**
 ...
 */
export type DataSchemaClassFactory<T extends object = object> = () => Constructor<T>;
/**
 ...
 * Class metadata key.
 */
export declare const DATA_SCHEMA_CLASS_METADATA_KEY: MetadataKey<DataSchemaMetadata>;
/**
 * Properties metadata key.
 */
export declare const DATA_SCHEMA_PROPERTIES_METADATA_KEY: MetadataKey<DataSchemaPropertyMetadataMap>;
